    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <a href="Admin" style="color:white; margin-right:10px;">English</a>
          <a href="D_Admin" style="color:white; font-size:17px;">دری</a>
        </div>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs" style="font-family:Times New Roman;">Library MIS</span>
                </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="Admin">
                <i ></i> <span class="fa fa-dashboard">&nbsp &nbsp  Home</span> <i class=" fa fa-angle-right pull-right"></i>
              </a>

            </li>
            <li class="treeview ">
              <a href="#">
                <span class="	fa fa-book">&nbsp &nbsp Book</span>
                <i class=" fa fa-angle-right  pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="book"><i class="fa fa-circle-o"></i> Show Book</a></li>
                <li><a href="insert"><i class="fa fa-circle-o"></i>  Add Book</a></li>
                <li><a href="borrow"><i class="fa fa-circle-o"></i> Borrow Book </a></li>
                <li><a href="borrow_insert"><i class="fa fa-circle-o"></i> Add Borrow</a></li>
              </ul>
            </li>
            <li class="treeview ">
              <a href="#">
                <span class="	fa fa-newspaper-o">&nbsp &nbsp Magazine</span>
                <i class=" fa fa-angle-right  pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="magazine"><i class="fa fa-circle-o"></i> Show Magazine</a></li>
                <li><a href="mg_insert"><i class="fa fa-circle-o"></i>  Add Magazine</a></li>
                <li><a href="borrow_magazine"><i class="fa fa-circle-o"></i> Borrow Magazine </a></li>
                <li><a href="mgborrow_insert"><i class="fa fa-circle-o"></i>  New Borrow</a></li>
              </ul>
            </li>
            <li class="treeview ">
              <a href="#">
                <span class="	glyphicon glyphicon-book"> Monograph</span>
                <i class=" fa fa-angle-right  pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="monograph"><i class="fa fa-circle-o"></i> Show Monograph</a></li>
                <li><a href="m_insert"><i class="fa fa-circle-o"></i>  Add Monograph</a></li>
                </ul>
            </li>
            <li class="treeview ">
              <a href="#">
                <span class="glyphicon glyphicon-user"> Members</span>
                <i class=" fa fa-angle-right  pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="member"><i class="fa fa-circle-o"></i> Show Members</a></li>
                <li><a href="member_insert"><i class="fa fa-circle-o"></i>  Add Member</a></li>
      ...
      <div class="content-wrapper" style="background-color:#EADBB6!important; ">
      ...
      <footer class="main-footer" style="background-color: #230D00!important; color: #fff;">
        <div class="col-md-5">

        </div>
        <strong> <a href="Admin"style=" color: #fff;" >Library Mangment System</a>.</strong>
      </footer>
