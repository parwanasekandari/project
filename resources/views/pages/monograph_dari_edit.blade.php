 ...
 <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
    ...
    <div class="panel-body" >
      <div class="row">
        ...
        <div class="col-md-8">
      <form  id="demo-form" data-parsley-validate class="form-horizontal form-label-left" method="post"  action="/dari_mono_update/{{$monograph->id}}">
          {{method_field('patch')}}
       <input type="hidden" name="_token" value="{{csrf_token()}}">

       <div class="form-group">
       <div class="col-sm-11">
         <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="author" value="{{$monograph->monograph_owner}}">
       </div>
       ...
       <div class="form-group">
       <div class="col-sm-11">
         <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="name"  value="{{$monograph->	mongraph_name}}">
       </div>
       ...
       <div class="form-group">
       <div class="col-sm-11">
         <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="department"  value="{{$monograph->department}}">
       </div>
       ...
       <div class="form-group">
       <div class="col-sm-11">
         <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="supervisor"  value="{{$monograph->supervisor}}">
       </div>
       ...
       <div class="form-group">
       <div class="col-sm-11">
         <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="year" value="{{$monograph->m_year}}" >
       </div>
       ...
       <div class="form-group">
       <div class="col-sm-11">
         <textarea name="desctription" rows="6" cols="73"> {{$monograph->description}}</textarea>
       </div>
