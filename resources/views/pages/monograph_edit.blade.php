  ...
  <div class="panel ">
    <div class="panel-heading apanel">
      <div class="row">
       ...
       <div class="col-md-7 ">
       <h2 class="text-left astyle" >Monograph Edit</h2>
       </div>
      </div>
    </div>
    <div class="panel-body" >

      <form  id="demo-form" data-parsley-validate class="form-horizontal form-label-left" method="post"  action="/m_update/{{$monograph->id}}">
          {{method_field('patch')}}
       ...
       <div class="form-group">
         ...
         <div class="col-md-7 col-sm-7 col-xs-12">
           <textarea name="desctription" placeholder="write Description" rows="6" cols="45"> {{$monograph->description}}</textarea>
         </div>
       </div>
