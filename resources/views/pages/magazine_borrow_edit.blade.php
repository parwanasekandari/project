   ...
   <div class="panel panel-default">
       ...
       <div class="panel-heading apanel">
          <div class="row">
            ...
            <div class="col-md-7 ">
        <h2 class="text-left astyle" >Update Magazine Barrow</h2>
        </div>
        </div>
       ...
       <div class="panel-body">
         ...
         <form  id="demo-form" data-parsley-validate class="form-horizontal form-label-left" method="post"  action="/magazine_barrow_update/{{$magazine->id}}">
             {{method_field('patch')}}
