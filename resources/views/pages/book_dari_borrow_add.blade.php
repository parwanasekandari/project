     ...
     <div class="panel panel-default">
       ...
       <div class="panel-body">
         ...
         <div class="row">
           ...
           <div class="col-md-8">
         <form  id="demo-form" data-parsley-validate class="form-horizontal form-label-left" method="post"  action="/dari_barrow_insert">
          ...
          <div class="col-md-5 " >
             ...
             <input type="submit" class="btn abtn" name="submit" value="ثبت نمودن">
          </div>
