  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="panel ">
      ...
      <div class="row">
        ...
        <div class="col-md-7 ">
        <h2 class="text-left astyle" > Members List</h2>
        </div>
      </div>
      </div>
              ...
              <div class="col-md-12">
                  ...
                  <div class="x_content">
                    <div class="row">
                      ...
                      <div class="col-md-4 col-sm-7 col-xs-11 profile_details" >
                        <div class="well profile_view">
                          <div class=" col-sm-12">
                            <h2 class="brief" style="font-family:Times;"><i><b>{{$show->name}}</b></i></h2>
                            <div class="left  col-md-6 col-sm-12 col-xs-12">
                                <ul class="list-unstyled">
                                <li><i class="fa fa-envelope-square"></i> {{$show->email}} </li>
                                <li><i class="fa fa-phone"></i> {{$show->phone_no}} </li>
                          ...
                          <div class="col-xs-12 bottom text-center">
                            ...
                            <a  href="/member_detail/{{$show->id}}" ><button type="button" class="btn abtn btn-xs">
