  ...
  <div class="row">
   <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
      ...
      <div class="row">
       ...
       <div class="col-md-7 ">
       <h2 class="text-left astyle" >  Members details</h2>
       </div>
     </div>
      </div>
  ...
  <div class="well profile_view">
    <div class="col-sm-12">
      ...
      <div class="right col-xs-4 text-right">
        <img src="/lms/{{$member->photo}}" alt="" class="img-circle img-responsive" style="height:100px !important; width:100px !important;">
      </div>
    </div>
