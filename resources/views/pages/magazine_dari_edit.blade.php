     ...
     <div class="panel panel-default">
       ...
       <div class="panel-heading apanel">
         <div class="row">
           ...
           <div class="col-md-6 ">
           <h2 class="text-left astyle" >ویرایش مجله</h2>
           </div>
       ...
       <div class="panel-body">
         ...
         <form  action="/dari_mg_update/{{$magazine->id}}" method="post" data-parsley-validate class="form-horizontal form-label-left">
          {{method_field('patch')}}
            ...
            <div class="form-group">
            <div class="col-sm-11">
              <textarea name="description" rows="8" cols="73 "  > {{$magazine->desctiption}}</textarea>
            </div>
